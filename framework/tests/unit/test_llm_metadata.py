...
class TestLLMResponseMetadata:
    ...
    def test_successful_response_has_metadata(self):
        ...
        mock_response.choices[0].message.content = '{"reasoning": "test", "tool_calls": null, "result": "answer", "is_finished": true}'
    ...
    def test_metadata_usage_matches_message_tokens(self):
        ...
        mock_response.choices = [Mock()]
        mock_response.choices[0].finish_reason = "stop"
        mock_response.choices[0].message.content = '{"reasoning": "x", "tool_calls": null, "result": "y", "is_finished": true}'
    ...
    def test_model_name_captured_even_if_different_from_requested(self):
        ...
        mock_response.choices = [Mock()]
        mock_response.choices[0].finish_reason = "stop"
        mock_response.choices[0].message.content = '{"reasoning": "test", "tool_calls": null, "result": "x", "is_finished": true}'
        mock_response.usage.prompt_tokens = 10
        mock_response.usage.completion_tokens = 20
        mock_response.usage.total_tokens = 30
